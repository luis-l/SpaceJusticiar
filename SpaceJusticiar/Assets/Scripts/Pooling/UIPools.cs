...
public class UIPools : MonoBehaviour
{
    ...
    public static UIPools Instance
    {
        get
        {
            if (_instance == null) {
                _instance = FindObjectOfType<UIPools>();
            }
    ...
    public void Init()
    {
        ...
        string rootPath = "Canvas/UIPoolRoot/";
        _poolRoot = GameObject.Find(rootPath).transform;
        if (_poolRoot == null)
            throw new UnityException("Failed to find UI Object Pool Root");
    }
